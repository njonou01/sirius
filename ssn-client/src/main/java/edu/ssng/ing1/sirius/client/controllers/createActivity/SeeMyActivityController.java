...
public class SeeMyActivityController implements Initializable {
    ...
    public void oneActivity(Activite activite) {
        ...
        FontIcon quitIcon = new FontIcon(FontAwesomeRegular.COMMENT_DOTS); 
        discussIcon.setIconColor(Color.valueOf("#2361a6")); 
        discussIcon.setIconSize(25);
    ...
    //     FontIcon discussIcon = new FontIcon("far-comment-dots", Color.valueOf("#2361a6"), 25);
    //     discussIcon.setOnMouseClicked(event -> goToDiscution()); 

    //     FontIcon quitIcon = new FontIcon("fas-sign-out-alt", Color.valueOf("#b03a65"), 25);
    ...
    //     detailsVBox.getChildren().addAll(activityNameLabel, creatorLabel, timeHBox, buttonHBox);
