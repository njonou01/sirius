...
//                 new Message(1, 1, 2, "Message 1", null, new Timestamp(System.currentTimeMillis())),
//                 new Message(2, 1, 2, "Message 2", null, new Timestamp(System.currentTimeMillis())),
//                 new Message(3, 2, 1, "Message 3", null, new Timestamp(System.currentTimeMillis())));
...
//                             ", Message: " + message.getMessageText() + ", Envoyé à: " + message.getSentAt());
//                 }
//             }
//         });
