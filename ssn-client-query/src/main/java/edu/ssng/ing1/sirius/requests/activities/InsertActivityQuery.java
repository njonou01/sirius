...
public class InsertActivityQuery {
    ...
    // public static void InsertClient(String Birthday, String Email, String phone, String firstname, String lastname, String gender, String id_language, String mdp) throws IOException, InterruptedException, SQLException {
    ...
    //     guy.setBirthday(Birthday);
    //     guy.setEmail(Email);
    //     guy.setFirstname(firstname);
    //     guy.setGender(gender);
    //     guy.setId_language(Integer.parseInt(id_language));
    //     guy.setPhonenumbrer(phone);
    //     guy.setMdp(mdp);
    ...
    //     try {
    //         InsertActivite("1990-05-03 20:00:00", "1990-05-03 20:00:00", "1990-05-03 20:00:00", "GTA", "on aime le GTA", "jeu", "Acceuil", "public", "EMF", 2, 3);
    //     } catch (IOException e) {
