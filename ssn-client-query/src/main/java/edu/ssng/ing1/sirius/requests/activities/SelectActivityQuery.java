...
public class SelectActivityQuery {
...
public static void main(String[] args) throws IOException, InterruptedException, SQLException {
    ...
    public static Activites SelectActivite() throws IOException, InterruptedException, SQLException {
        ...
        request.setRequestOrder("SELECT_ALL_ACTIVITY");
