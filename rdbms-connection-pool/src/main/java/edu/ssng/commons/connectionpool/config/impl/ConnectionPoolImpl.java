package edu.ssng.commons.connectionpool.config.impl;

import edu.ssng.commons.connectionpool.config.DatabaseConnectionBasicConfiguration;
...
public class ConnectionPoolImpl {
    ...
    // A really appropriate JAVA Object (since JAVA 7) to implement this kind of
    // stuff
    ...
    private static final BlockingDeque<Connection> connections = new LinkedBlockingDeque<Connection>(
            DatabaseConnectionBasicConfiguration.getInstance().getPoolSize());
    ...
    private void initConnections() throws SQLException {
        ...
        logger.debug("{} created, pool size = {}", justTobeSureConnection,
                DatabaseConnectionBasicConfiguration.getInstance().getPoolSize());
    }
    ...
    public void terminatePool() throws SQLException {
        ...
        logger.debug("{} released, pool size = {}", justTobeSureConnection,
                DatabaseConnectionBasicConfiguration.getInstance().getPoolSize());
    }
